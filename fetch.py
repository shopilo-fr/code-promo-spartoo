#!/usr/bin/env python3
"""
Recuperation des codes promo Spartoo depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/spartoo.com
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/spartoo.com"
STORE_NAME = "Spartoo"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Spartoo depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-spartoo)"
    }
    try:
